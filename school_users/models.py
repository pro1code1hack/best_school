...
class UserAuth(models.Model):
    ...
    ch_password = models.CharField(max_length=40, verbose_name='password')           # has to be hashed
    b_is_active = models.BooleanField(default=False)
...
class UserProfile(models.Model):
    i_user_id = models.ForeignKey(UserAuth, on_delete=models.CASCADE , verbose_name='Пользователь')
    ...
    def __str__(self):
        return "{}".format(self.i_user_id.ch_username)
